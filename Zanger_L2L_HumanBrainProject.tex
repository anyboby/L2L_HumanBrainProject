...
\begin{figure}[thpb]
        \centering
        \framebox{\parbox{3in}{
        \includegraphics[scale=.35]{LSTM3-chain.png}
  }}
...
overview over variations of the vanilla LSTM, such as the introduction of peepholes by Gers & Schmidhuber or the lighter Gated Recurrent Unit (GRU) 
...
a state-of-the-art algorithm such as backpropagation is yet to be emerge. We will focus on a more 
biologically realistic training rule called spike-timing-dependant plasiticy (STDP). The key feature of this approach is 
